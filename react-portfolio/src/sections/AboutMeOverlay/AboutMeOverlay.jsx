        ...
        <div className="AboutMeOverlay">
            <div className="AboutMeOverlayContent">
                ...
                <div className="AboutMeTxt">
                    <p>
                        Hello! My name's Diana, and <span className="Bold">I am a second year student at SFU, and an aspiring game developer.</span> I am currently working towards building new projects and learning about various topics to build upon my experience. Right now, <span className="Bold">I am interested in computer graphics and vision</span> and am looking forwards to learning more about this field!
                    </p>
